		...
		var resource = this.props.state,
	  	...
	  	return (
	  		<fieldset className="resource">
				<OverlayTrigger placement='left' overlay={<Tooltip><strong>Help!</strong> Enter the title of the reference</Tooltip>}>
	  				<p className="cf">title: <input maxLength="30" value={resource.title} onChange={ setValue.bind(this, outsideIndex, "title") }></input></p>
				</OverlayTrigger>
				<OverlayTrigger placement='left' overlay={<Tooltip><strong>Help!</strong> Enter the author of the reference</Tooltip>}>
	  				<p className="cf">author: <input maxLength="100" value={resource.author} onChange={ setValue.bind(this, outsideIndex, "author") }></input></p>
				</OverlayTrigger>
				<OverlayTrigger placement='left' overlay={<Tooltip><strong>Help!</strong> Enter the url of the reference</Tooltip>}>
