		...
		// function(e){console.table(e.target.value);};
	  	...
	  	return (
	  		<div className="resource">
	  			...
	  			<p>author: <input className="editable" defaultValue={resource.author} onChange={ setValue }></input></p>
	  			<p>url: <input className="editable" defaultValue={resource.url} onChange={ setValue }></input></p> 
	   		</div>
	  	)
  	}
}
